...
- [Your First Hero](./getting-started/first-hero.md)

# Architecture
- [Overview](./architecture/overview.md)
- [Core Components](./architecture/core-components.md)
- [Pipeline System](./architecture/pipeline.md)
- [Plugin Architecture](./architecture/plugins.md)
- [Configuration System](./architecture/configuration.md)

# Pipeline Stages
- [Image-to-3D Generation](./pipeline/generation.md)
- [Part Decomposition](./pipeline/decomposition.md)
- [Skeleton Rigging](./pipeline/rigging.md)
- [URDF Generation](./pipeline/urdf.md)
- [Simulation Setup](./pipeline/simulation.md)
- [RL Training](./pipeline/training.md)

# Development Guide
- [Development Setup](./development/setup.md)
- [Creating Plugins](./development/plugins.md)
...
- [PartCrafter Integration](./integration/partcrafter.md)

# Examples
- [Complete Pipeline Demo](./examples/complete-demo.md)
...
- [File Formats](./appendices/file-formats.md)
